        ...
        body: SafeArea(
          child: Center(
            child: Column(
              ...
              Text("<dev/tracker>",style: TextStyle(fontSize: 50,color: Color(0xFF93B1A6)),),
              const SizedBox(height: 50),
            ...
            const SizedBox(height: 25,),
              ...
              LoginButton(onTap: signUserIn,),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Not a member yet? ",style: TextStyle(color: Colors.white),),
                    Text("Apply Now",style: TextStyle(color: Color(0xFF93B1A6)),)
                  ],
                ),
                const SizedBox(height: 25,),
